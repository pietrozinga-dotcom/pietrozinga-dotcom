...
```yaml
Open To:
  - Full-Stack Engineering roles (Next.js / TypeScript / Supabase)
  - AI/ML Integration & Applied AI collaborations
  - InsurTech & B2B SaaS product partnerships
  - Technical consulting on automation & document intelligence
```
...
|---|---|---|
| Document OCR & Extraction | Advanced | Built AI-driven OCR pipelines to parse and classify insurance documents at scale |
| Prompt Engineering | Advanced | Designs structured prompts for classification, extraction, and workflow decisioning |
| Email-to-Workflow Automation | Advanced | AI-based email analysis and classification feeding directly into deal pipelines |
| RAG Systems | Intermediate | Building retrieval-augmented pipelines for contextual document search |
| Model Fine-Tuning | Intermediate | Iterating on classification accuracy for domain-specific document types |
...
<details>
<summary><b>CFA Broker — Insurance Brokerage Management Platform</b></summary>

<br/>

A comprehensive platform for insurance brokers to manage deals, documents, and client workflows end-to-end, with AI embedded across the pipeline.

| Stack | Scale | Performance | Security | Impact | Repository |
|---|---|---|---|---|---|
| Next.js, TypeScript, Supabase, AI/OCR | Multi-tenant broker platform | Optimized query & document pipelines | Role-based access, GDPR-aware data handling | Automates deal intake & document classification | Private |

Built to remove manual data entry from brokerage operations — incoming emails and documents are automatically classified, extracted, and routed into structured deal records, cutting administrative overhead for brokers.

</details>

<details>
<summary><b>Rental Property Management System</b></summary>

<br/>

An integrated booking and property management tool with BnB platform synchronization.

| Stack | Scale | Performance | Security | Impact | Repository |
|---|---|---|---|---|---|
| Next.js, TypeScript, Supabase, Google Apps Script | Multi-property booking sync | Real-time calendar sync | Secured API integrations | Centralizes booking operations across platforms | Private |

Consolidates bookings, availability, and guest communication into a single operational dashboard, reducing manual reconciliation across listing platforms.
...
Founded and lead technical development of an insurance-technology product suite, owning architecture, AI integration, and delivery from concept to production.

- Architected and built CFA Broker end-to-end using Next.js, TypeScript, and Supabase
- Designed AI-driven email classification and document OCR/extraction systems
- Built automation workflows using Google Apps Script for business operations
...
| Recognition | Details |
|---|---|
| Founder | Built and launched an insurance brokerage SaaS platform from the ground up |
| Automation Impact | Reduced manual document processing through AI-driven classification pipelines |
...
```yaml
Learning:
  - Advanced RAG architectures for document intelligence
  - EU AI Act & GDPR compliance for AI-driven products
  - Business formation and financial modeling

Building:
  - CFA Broker: end-to-end insurance brokerage platform
  - AI-powered document classification & OCR pipelines

Exploring:
  - Fine-tuning models for domain-specific extraction tasks
  - Advanced prompt engineering patterns

Open To:
  - AI/ML integration collaborations
